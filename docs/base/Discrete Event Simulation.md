...
Input modeling concerns the construction of **stochastic input processes** that drive a
simulation model. The quality of a simulation study depends critically on how well the
input models represent the real system.

This chapter focuses on **data-driven modeling** and **parametric modeling** of input
processes.
...
- 9.3 Modeling Nonstationary Processes *(optional)*

---

## 9.1 Trace-Driven Modeling of Stationary Processes

In **trace-driven simulation**, observed data are used directly as input.
...
- stable service-time distribution
...
2. Use recorded observations directly in simulation
3. Replay data to drive events

---

### Advantages

- High fidelity to observed behavior
- No distributional assumptions required
- Useful when data are abundant
...
- Poor extrapolation to new conditions
...
Trace-driven modeling is appropriate when:
- realism is critical
- future conditions closely resemble the past

---

## 9.2 Parametric Modeling of Stationary Processes

Parametric modeling assumes data are generated by a **known family of distributions**.
...
1. Collect data
2. Choose candidate distribution family
3. Estimate parameters
4. Validate the fitted model
5. Generate synthetic data from the model
...
- graphical comparison (histograms, Q–Q plots)
- goodness-of-fit tests

No model is exact; the goal is **adequate realism**.
...
- Easy extrapolation
- Efficient generation of large samples
...
- Poor fit leads to misleading results

---

### Trade-off

Trace-driven vs parametric modeling is a trade-off between:
- realism
- generality
- flexibility
...
Some systems exhibit **time-varying behavior**.
...
Such processes cannot be modeled using stationary distributions.

---

### Modeling Techniques

- piecewise stationary models
- time-dependent Poisson processes
- segmentation of data by time intervals
...
## Input Modeling and Simulation Validity

Poor input models lead to:
- invalid output
- misleading conclusions

Input modeling is often the **most difficult and most important** part of a simulation
study.
...
- Input models drive simulation behavior
- Trace-driven modeling uses observed data directly
- Parametric modeling uses fitted distributions
- Nonstationary processes require special treatment
- Careful input modeling is essential for validity
